...
/**
 * BQRedemptionUpdateInputModel
 */
public class BQRedemptionUpdateInputModel   {
  private String rewardPointsTransactionInstanceReference = null;

  private String redemptionInstanceReference = null;
  ...
  private Object redemptionUpdateActionTaskRecord = null;

  private String redemptionUpdateActionRequest = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Redemption instance 
   * @return redemptionInstanceReference
  **/

  public String getRedemptionInstanceReference() {
    return redemptionInstanceReference;
  }

  public void setRedemptionInstanceReference(String redemptionInstanceReference) {
    this.redemptionInstanceReference = redemptionInstanceReference;
  }
  ...
  **/
   ...
   * @return redemptionUpdateActionTaskRecord
  **/

  public Object getRedemptionUpdateActionTaskRecord() {
    return redemptionUpdateActionTaskRecord;
  }

  public void setRedemptionUpdateActionTaskRecord(Object redemptionUpdateActionTaskRecord) {
    this.redemptionUpdateActionTaskRecord = redemptionUpdateActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Details of the update action service request 
   * @return redemptionUpdateActionRequest
  **/

  public String getRedemptionUpdateActionRequest() {
    return redemptionUpdateActionRequest;
  }

  public void setRedemptionUpdateActionRequest(String redemptionUpdateActionRequest) {
    this.redemptionUpdateActionRequest = redemptionUpdateActionRequest;
  }
