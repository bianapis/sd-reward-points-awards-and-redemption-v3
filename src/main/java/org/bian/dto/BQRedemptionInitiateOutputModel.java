...
/**
 * BQRedemptionInitiateOutputModel
 */
public class BQRedemptionInitiateOutputModel   {
  private String redemptionInstanceReference = null;

  private String redemptionInitiateActionReference = null;
  ...
  **/
   ...
   * @return redemptionInitiateActionReference
  **/

  public String getRedemptionInitiateActionReference() {
    return redemptionInitiateActionReference;
  }

  public void setRedemptionInitiateActionReference(String redemptionInitiateActionReference) {
    this.redemptionInitiateActionReference = redemptionInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Redemption instance (e.g. initialised, pending, active) 
